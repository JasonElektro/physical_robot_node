...
noSpeed = 0x0000    # 0
speedCoef = 0.4     # Speed reduction factor
rmodeSpeedCoef = 0.5  # R-mode speed coefficient
rmodeBackwardSpeedCoef = 0.6  # R-mode backward speed coefficient
...
class BCRBotStandalone:
    ...
    def init_navigation_state(self):
        ...
        self.r_mode_forward_speed = 0.8
        self.r_mode_turn_speed = 0.6
    ...
    def handle_charging_navigation(self):
        ...
        if self.lidar_min_distance < self.charging_emergency_stop_threshold:
            ...
            # Move forward slowly when path is clear
